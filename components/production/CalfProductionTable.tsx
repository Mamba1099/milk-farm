                  ...
                  >
                    ...
                    <TableCell className="px-3 py-3 text-center">
                      <div className="flex items-center justify-center gap-1">
                        <Input
                          ...
                          className="w-14 text-center text-sm border-orange-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md"
                          placeholder="0.0"
                          disabled={isDisabled}
                        />
                    ...
                    <TableCell className="px-3 py-3 text-center">
                      <Button
                        ...
                        className="bg-orange-600 hover:bg-orange-700 text-white px-3 py-1.5 text-xs rounded-md"
                        size="sm"
                      >
                        Submit
                      </Button>
