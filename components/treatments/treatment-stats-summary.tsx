    ...
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
      ...
      <Card className="p-0 shadow-lg border-0 bg-gradient-to-br from-cyan-200 to-cyan-400 w-full">
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center justify-center w-12 h-12 min-w-0 bg-cyan-700 rounded-full shadow mb-2">
      ...
      <Card className="p-0 shadow-lg border-0 bg-gradient-to-br from-teal-200 to-teal-400 w-full">
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center justify-center w-12 h-12 min-w-0 bg-teal-700 rounded-full shadow mb-2">
      ...
      <Card className="p-0 shadow-lg border-0 bg-gradient-to-br from-purple-200 to-purple-400 w-full">
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center justify-center w-12 h-12 min-w-0 bg-purple-700 rounded-full shadow mb-2">
      ...
      <Card className="p-0 shadow-lg border-0 bg-gradient-to-br from-orange-200 to-orange-400 w-full">
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center justify-center w-12 h-12 min-w-0 bg-orange-700 rounded-full shadow mb-2">
      ...
      <Card className="p-0 shadow-lg border-0 bg-gradient-to-br from-red-200 to-red-400 w-full">
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center justify-center w-12 h-12 min-w-0 bg-red-700 rounded-full shadow mb-2">
      ...
      <Card className="p-0 shadow-lg border-0 bg-gradient-to-br from-yellow-200 to-yellow-400 w-full">
        <div className="flex flex-col items-center p-6">
          <div className="flex items-center justify-center w-12 h-12 min-w-0 bg-yellow-700 rounded-full shadow mb-2">
